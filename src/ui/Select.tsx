  ...
  return (
    <>
      ...
      <select
        ...
        className="focus:border-blue-500 focus:ring-blue-500 dark:text-white block w-full rounded-lg bg-black-900 px-2 py-1 text-xl text-black-200 shadow-md shadow-black-950 dark:border-black-600 dark:bg-black-700 dark:placeholder-black-400 dark:focus:border-black-500 dark:focus:ring-black-500"
      >
        {options.map((option) => (
